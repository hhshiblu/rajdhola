const styles = {
  ...
  productDiscountPrice: "font-bold text-[#d55b45] text-[16px]  font-Roboto",
  letestDiscountPrice:
    "font-semibold text-[#d55b45] text-[18px] text-[#333] font-Roboto",
  price: "font-[500] text-[13px]  pl-3 mt-[-4px] line-through",
  ...
  input: "w-full border p-1 rounded-[4px] text-[13px] 800px:text-[16px]",
  activeStatus:
